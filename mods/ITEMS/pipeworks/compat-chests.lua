		...
		if open_chests[pn] then
			...
			if fields.quit then
				...
				minetest.after(0.2, function()
					minetest.swap_node(pos, { name = "chests:" .. swap, param2 = node.param2 })
...
local old_chest_def = table.copy(minetest.registered_items["chests:chest"])
local old_chest_open_def = table.copy(minetest.registered_items["chests:chest_open"])
local old_chest_locked_def = table.copy(minetest.registered_items["chests:chest_locked"])
local old_chest_locked_open_def = table.copy(minetest.registered_items["chests:chest_locked_open"])

-- Override Construction
local override_protected, override, override_open, override_protected_open
override_protected = {
	tiles = {
		"chests_chest_top.png"..tube_entry,
		"chests_chest_top.png"..tube_entry,
		"chests_chest_side.png"..tube_entry,
		"chests_chest_side.png"..tube_entry,
	...
	on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
		...
		if not chest_lid_obstructed(pos) then
			minetest.swap_node(pos,
					{ name = "chests:" .. "chest_locked" .. "_open",
					param2 = node.param2 })
		end
...
override_protected.tiles = { -- Rearranged according to the chest registration in Minetest_Game.
	"chests_chest_top.png"..tube_entry,
	"chests_chest_top.png"..tube_entry,
	"chests_chest_side.png"..tube_entry.."^[transformFX",
	"chests_chest_side.png"..tube_entry,
	"chests_chest_side.png"..tube_entry,
	"chests_chest_lock.png",
}
...
minetest.override_item("chests:chest", override)
minetest.override_item("chests:chest_open", override_open)
minetest.override_item("chests:chest_locked", override_protected)
minetest.override_item("chests:chest_locked_open", override_protected_open)
