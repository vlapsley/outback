...
abstract_ferns.config.enable_horsetails_on_grass 	= true		-- on dirt with grass
abstract_ferns.config.enable_horsetails_on_stones 	= true		-- on gravel, mossy cobble
--
-- Tree_Fern
abstract_ferns.config.enable_treeferns_in_victas	= true		-- victorian-forests and tasmania
abstract_ferns.config.enable_treeferns_in_fnq	 	= true		-- far north queensland
--
-- Giant_Tree_Fern
abstract_ferns.config.enable_giant_treeferns_in_victas	= true	-- victorian-forests and tasmania
abstract_ferns.config.enable_giant_treeferns_in_fnq		= true	-- far north queensland
