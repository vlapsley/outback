...
minetest.register_on_generated(function(minp, maxp, seed)
	...
	if not node["stone"] then
		node["stone"] = minetest.get_content_id("core:stone")
		node["sandstone"] = minetest.get_content_id("core:sandstone")
		node["dirt"] = minetest.get_content_id("core:dirt")
		node["lawn"] = minetest.get_content_id("core:dirt_with_grass")
		node["dry"] = minetest.get_content_id("core:dirt_with_dry_grass")
		node["snowblock"] = minetest.get_content_id("core:snowblock")
		node["desert_sand"] = minetest.get_content_id("core:desert_sand")
		node["sand"] = minetest.get_content_id("core:sand")
		...
		-- Water
		node["water"] = minetest.get_content_id("core:water_source")
