...
local recipes = {
	...
	{"base:copper_ingot 3",        "base:tin_ingot",         "base:bronze_ingot 4"},
	...
	{"base:copper_ingot 2",        "technic:zinc_ingot",         "technic:brass_ingot 3"},
	{"base:sand 2",                "technic:coal_dust 2",        "technic:silicon_wafer"},
