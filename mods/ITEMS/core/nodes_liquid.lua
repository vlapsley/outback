...
minetest.register_node("core:water_source", {
	...
	sounds = core.node_sound_water_defaults(),
})
...
minetest.register_node("core:river_water_source", {
	description = "River Water Source",
	drawtype = "liquid",
	tiles = {
		{
			name = "core_river_water_source_animated.png",
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
				aspect_h = 16,
	...
	drowning = 1,
	liquidtype = "source",
	liquid_alternative_flowing = "core:river_water_flowing",
	liquid_alternative_source = "core:river_water_source",
	liquid_viscosity = 1,
...
minetest.register_node("core:river_water_flowing", {
	description = "Flowing River Water",
	drawtype = "flowingliquid",
	tiles = {"core_river_water.png"},
	special_tiles = {
		{
			name = "core_river_water_flowing_animated.png",
			backface_culling = false,
			animation = {
				type = "vertical_frames",
				aspect_w = 16,
